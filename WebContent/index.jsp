...
<link type="text/css" rel="stylesheet"
	href="${pageContext.request.contextPath}/statics/style/reset.css">
<link type="text/css" rel="stylesheet"
	href="${pageContext.request.contextPath}/statics/style/main.css">
</head>
<body>
	<div class="headerBar">
		<div class="logoBar login_logo">
			<div class="comWidth">
				<div class="logo fl">
					<a href="#"><img
						src="${pageContext.request.contextPath}/statics/images/logo.jpg" alt="慕课网"></a>
				</div>
	...
	<div class="footer">
		...
		<p class="web">
			<a href="#"><img
				src="${pageContext.request.contextPath}/statics/images/webLogo.jpg"
